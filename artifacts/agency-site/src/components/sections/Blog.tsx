  ...
  return (
    ...
    >
      ...
      <div className="p-6">
        ...
        <div className="inline-flex items-center gap-2 text-xs font-bold tracking-widest uppercase text-primary/60 group-hover:text-primary transition-colors duration-300">
          Read Article
...
export function Blog() {
  return (
    <section id="blog" className="py-16 md:py-32 relative z-10 border-t border-white/5">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_40%_at_50%_50%,rgba(202,163,83,0.03),transparent)] pointer-events-none" />
      <div className="container px-4 md:px-6 relative z-10">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-10 md:mb-16 gap-6">
          ...
          >
            ...
            <h2 className="text-4xl md:text-6xl font-black tracking-tight">The Playbook</h2>
          </motion.div>
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
          ...
          >
            <p className="text-foreground/50 max-w-sm text-base leading-relaxed md:text-right">
