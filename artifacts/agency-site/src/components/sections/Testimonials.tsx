...
const testimonials = [
  {
    quote:
      "Core Elite Digital rebuilt our entire Shopify store and took over our Instagram and Meta ads. In 5 months, our monthly orders went from 800 to nearly 2,600. I was skeptical at first — now I tell every founder I know to call them before anyone else.",
    author: "Rahul Sharma",
    role: "Co-Founder",
  ...
  {
    quote:
      "We were burning money on ads that weren't converting. Core Elite Digital audited everything, rebuilt our landing pages, and restructured our funnel. Our cost per acquisition dropped by 60% in the first 8 weeks. The team is sharp, fast, and genuinely cares.",
    author: "Priya Mehta",
    role: "Head of Growth",
    company: "NestFin",
  ...
  {
    quote:
      "Working with Core Elite Digital feels like having an elite in-house team. They rebranded ScaleTech end-to-end — website, pitch deck, LinkedIn presence. Within a quarter we closed two enterprise contracts we'd been chasing for over a year. Exceptional work.",
    author: "David Chen",
    role: "Founder & CEO",
    company: "ScaleTech",
    location: "Singapore",
  ...
  {
    quote:
      "Our Instagram went from 14K to 580K followers in 8 months. But more importantly, the content actually drives showroom walk-ins now. Core Elite Digital understood our brand voice immediately and executed without hand-holding. Rare and valuable.",
    author: "James Harlow",
    role: "Brand Director",
    company: "Apex Motors",
    location: "Dubai, UAE",
  ...
  {
    quote:
      "We rebranded our architecture firm with Core Elite Digital and raised our project fees by 40% the same year. Clients started coming to us — not the other way around. The website and brand positioning they built is simply in a different league.",
