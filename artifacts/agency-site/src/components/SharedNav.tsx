      ...
      <div className="container flex items-center justify-between h-16 md:h-20 px-4 md:px-6">
        ...
        >
          <div
            ...
            style={{ width: 36, height: 36, padding: 1.5, background: "linear-gradient(135deg, #8B6914 0%, #CAA353 55%, #F0C97A 100%)", borderRadius: 9, boxSizing: "border-box", boxShadow: "0 0 18px rgba(202,163,83,0.22)" }}
          >
            <div className="w-full h-full flex items-center justify-center" style={{ background: "#0c0c0e", borderRadius: 7 }}>
              <span
