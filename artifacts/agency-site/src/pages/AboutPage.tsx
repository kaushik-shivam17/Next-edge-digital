  ...
  return (
    <div className="relative min-h-screen bg-background text-foreground dark overflow-x-hidden">
      <SEO
        ...
        description="Meet Core Elite Digital — an elite AI-powered digital agency with 10+ projects delivered across 1+ countries. 98% client retention. Our mission: build digital empires for ambitious brands worldwide."
