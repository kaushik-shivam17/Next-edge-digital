  ...
  return (
    <div className="min-h-screen bg-background text-foreground dark">
      <div className="pt-28 pb-16 relative">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_60%_40%_at_50%_0%,rgba(202,163,83,0.06),transparent)]" />
